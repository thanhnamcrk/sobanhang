  ...
  return (
    <View style={styles.settingsModalOverlay}>
      <View style={styles.settingsModal}>
        ...
        {/* Nút tạo QR mới (chỉ hiển thị, không hoạt động) */}
        
        <TouchableOpacity onPress={() => generateAndSaveQR(amount)} style={styles.settingsButton}>

          <Text style={styles.settingsButtonText}>Tạo QR</Text>
        </TouchableOpacity>

        {/* Nút xem QR (chỉ hiển thị, không hoạt động) */}
        <TouchableOpacity 
          ...
          onPress={async () => {
            try {
              ...
              if (fileExists.exists) {
                ...
                // Display the images in a modal or component
